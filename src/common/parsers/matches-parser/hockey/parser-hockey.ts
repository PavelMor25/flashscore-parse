...
export default class ParserHockey implements ParserMatchInterface<hockeyMatchStat, jsonHockey> {
    ...
    parseMatch = async (id: string): Promise<hockeyMatchStat> => {
