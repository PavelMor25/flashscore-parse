...
import {matchStat} from "../../../types/am-football/match-stats.type.js";
...
export const getParseAmFootballMatch = async (page: Page, id: string): Promise<matchStat> => {
    const {
        NAME_TEAMS,
        SCORES,
        PERIODS,
...
export const getJsonAmFootball = (el: matchStat): jsonAmFootball => {
    console.log(el.stats, el.odds, el.exData)
    let {
        id = '',
